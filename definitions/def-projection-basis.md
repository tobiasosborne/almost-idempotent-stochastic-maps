...
**Status.** Locked on the recorded user ratification of 2026-07-24 (see
frontmatter `consensus:`; lock commit b9270ef4). An earlier draft-transcription
note stood here until 2026-07-27 (stale-body drift caught by
`AUDIT-F2-TYPING.md` correction 3).
