...
**Status.** af-VALIDATED 2026-07-27 (94th rigorous result): first-pass —
root validated, 12/12 nodes, taint clean (prover xhigh / verifiers high).
Export in the workspace; oracle `af-lem-stage1-group-closeness` +
`fr verify` PASS. Landed VERBATIM from the audited
`DESIGN-S1-GROUP-FACTORING.md` §2.2 (design skeleton 15/15 cap).
