...
status: proved
af: none
provenance: W67 wave (docs/waves/2026-07-14-W67-artifacts/): codex strategist (gpt-5.6-sol, xhigh) AESC-ATTACK-W67.md §1.2; fresh routine prover (gpt-5.6-sol, high) APPENDIX-W67-aesc-proofs.md; fresh hostile batched codex verifier (gpt-5.6-sol, xhigh), verdict VERDICT-W67-AESC-BATCH.md line SF: VALID. Reviewer != author.
owner: B
---

**Role (W67 A-esc routine, SF — synthetic-finance tail amplification).** Records the pointwise tail cost when an actorization-escape target lies within \(3\delta\) of the row hull.

**Mechanism (one line).** [[lem-hx-transverse-moment-identity]] and the normalized-carrier facts split the unit moment against an arbitrary nearest hull point to force \(\operatorname{Tail}_1(u)>\tau/8\).
