...
(`proofs/lem-maincb-outer-compression-transfer/export.md`; oracle pass;
tier routine; parallel-af worktree run af-m09, run 2 on a CLEAN
RE-SEED after run 1 STUCK on a tangled composite architecture — the
rebuilt tree derived both amplified rectangular-product applications
and exact compression naturality explicitly and passed hostile review
without a single challenge). Route: M07 at P=Q, M08 dimension
equality, exact amplification twice. MAIN campaign row M09.

**Build budget (BINDING on the af tree).** Design target/rounds/hard-cap:
9 / 3 / 13. Per-row skeleton and audit delta:
DESIGN-MAIN-STRUCTURE-v5.md sect-4.2 row M09. A hard-cap hit is a factoring stop,
not a rounds bump. Constants live in the proof body, never the contract.

**Provenance loci.** approximate_algebras.tex:1068-1082,1435-1441,1542-1544
