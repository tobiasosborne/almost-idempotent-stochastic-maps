...
owner: A
---
**Status.** `proved` — af-VALIDATED in-repo (root validated 6/6 nodes clean, run 1, tier routine, 2026-08-01; oracle af-lem-maincb-isomorphism-unit-control PASS). Contract transcribed verbatim from the audited
