...
**af-VALIDATED IN-REPO 2026-07-04** (run 1 clean, 6 rounds, zero open challenges): 32-node
adversarial tree (31 live + 1 archived), root `validated`, taint 32/32 clean; imports the
af-validated dep [[lem-pivot-removing-move]] as an external; fresh codex provers/verifiers per
node, Claude orchestrated only (§6). Export: `proofs/lem-collateral-import/export.md`. Status
flip is the mechanical reflection of the codex ledger.
