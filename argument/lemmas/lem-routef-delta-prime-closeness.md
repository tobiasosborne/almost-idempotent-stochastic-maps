...
deps: lem-routef-raw-factor-setting-formation; cor-kitaev-diagonal-cpization; lem-kitaev-diagonal-repair; lem-routef-ai-defect-linearization; lem-routef-functional-calculus-closeness; lem-thmainext-conditional; lem-routef-raw-factor-norms; lem-routef-raw-product-estimate
status: stated
af: seeded
provenance: DESIGN-LEDGER-DOMAINS-v2.md sect-2 row 5 (landed verbatim 2026-08-03, LaTeX flattened to registry ASCII); AUDIT-LEDGER-DOMAINS-v2.md LAND-14 with two exact corrections, both folded in; W78-ratified package front 3; user-ratified 2026-07-30, ledger front re-selected by the user 2026-08-03; RE-SCOPED 2026-08-05: ambient binding prefix + defs/deps repair per DESIGN-LEDGER-SETTING-RESCOPE-V2.md sect-3 (hostile re-audit AUDIT-LEDGER-SETTING-RESCOPE-V2.md LAND-WITH-EXACT-CORRECTIONS, corrections folded in), user-ratified 2026-08-05; deps += lem-kitaev-diagonal-repair 2026-08-08 (af-run verifier challenges ch-b3b21afb/ch-6751bedc: the row consumes pi(D)=I_B, q_t>=0 with sum 1, and the norm-one representation, exported only by the repair lemma's contract; contract bytes unchanged), user-ratified 2026-08-08; deps += lem-routef-ai-defect-linearization 2026-08-08 (af-run-3 verifier challenges ch-21217b7b/ch-25b20971: the CP-ization hypothesis needs A's involution identified with the inherited ambient adjoint on B(H), which that T0 contract exports verbatim — 'the inherited operator-space norms, involution, and unit'; contract bytes unchanged), user-ratified 2026-08-08; source approximate_algebras.tex:2771-2801; LEDGER-W74F-G-K.md:193-226; argument/lemmas/cor-kitaev-diagonal-cpization.md:4-9; AUDIT-LEDGER-DOMAINS.md:190
owner: A
