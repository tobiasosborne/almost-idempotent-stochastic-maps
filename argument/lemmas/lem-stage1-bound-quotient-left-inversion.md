---
id: lem-stage1-bound-quotient-left-inversion
kind: lemma
...
defs: def-stage1-polar-witness-data; def-approximate-unitary-space; def-epsilon-cstar-algebra; def-h-space-left-inversion
deps: lem-stage1-smooth-unitary-atlas; lem-stage1-smooth-polar-inverse; lem-stage1-explicit-smooth-unitary-operations; lem-stage1-quotient-manifold-package; lem-topology-quotient-manifold
status: proved
af: validated
workspace: proofs/lem-stage1-bound-quotient-left-inversion
...
**Status.** af-VALIDATED in-repo (2026-07-30): 13 live nodes (16 total,
3 archived), root `validated`, taint clean 16/16
(`proofs/lem-stage1-bound-quotient-left-inversion/export.md`; oracle
pass; tier routine, 13 live == cap 13, budget 9/4/13). Run 1 drew THREE
challenges — the (A_4)-openness inference, a smooth-structure
identification misusing the quotient-manifold uniqueness clause, and an
undeclared cross-node dependency — ALL repaired by the prover and
re-verified by fresh verifiers (the ambient-openness gap closed at
1.2.2). First parameterized B-row: binds e_quot^r, exports epsilon_B^r,
no polar-ledger edge. Contract VERBATIM from DESIGN-S1-ENDGAME-v5
sect-2 (audit v5 LAND; ratified 2026-07-30). Position 5/13.

**Build budget (BINDING on the af tree).** Design target/rounds/hard-cap:
9 / 4 / 13. The per-node skeleton is DESIGN-S1-ENDGAME-v5.md sect-4
(lem-stage1-bound-quotient-left-inversion); a hard-cap hit is a factoring stop, not a rounds bump. Constants
live in the proof body, never the contract.

**Provenance loci.** exact ledger clauses `argument/lemmas/lem-stage1-polar-constant-ledger.md:4`; `refs/kitaev-2405.02434/approximate_algebras.tex:895-912,945-955`
