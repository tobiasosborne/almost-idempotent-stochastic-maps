...
**Status.** af-VALIDATED 2026-07-27 (102nd rigorous result): first-pass —
root validated, 7/7 nodes, taint clean (tier routine, zero challenges).
Export in the workspace; oracle `af-lem-stage1-rectified-cstar-transport`
