...
af elevation per the design's projected budget 3/2. The former honest
cap is LIFTED: `lem-topology-finite-triangulation` is af-VALIDATED
in-repo (2026-07-29, 122nd rigorous result; bead `aism-j5t9` closed),
so both deps are T0.
