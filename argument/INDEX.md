...
| `lem-mass-split` | lemma | stated | none | A | Mass split: for an exact signed idempotent P and any row index v, writing a_j = … |
| `lem-residual-lower` | lemma | stated | none | A | Convex outsourcing: let C be the convex hull of finitely many points of R^n, and… |
| `lem-residual-upper` | lemma | stated | none | A | Residual distance bound: let C be the convex hull of finitely many points of R^n… |
