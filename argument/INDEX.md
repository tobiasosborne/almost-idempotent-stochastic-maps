...
| `conj-sl1a-deep-diagonal-cell` | lemma | conjecture | none | B | There exists a universal delta_D in (0,2^(-16)] such that no finite exact signed… |
| `conj-sl1a-intersection-diagonal-cell` | lemma | conjecture | none | B | There exists a universal delta_I in (0,2^(-16)] such that no finite exact signed… |
| `conj-sl1a-off-diagonal-cell` | lemma | conjecture | none | B | There exists a universal delta_X in (0,2^(-16)] such that no finite exact signed… |
...
| `lem-starvation-completion-obstruction` | lemma | proved | none | B | Bounded-slab starvation completion obstruction (K-free): for every finite I, eve… |
