...
| `lem-stage1-bound-inversion-isolation` | lemma | stated | none | A | Parameterized same-map actual-isolation package: for every universal def-stage1-… |
| `lem-stage1-bound-quotient-index-data` | lemma | stated | none | A | Parameterized complete quotient package: for every universal def-stage1-polar-wi… |
| `lem-stage1-bound-quotient-left-inversion` | lemma | stated | none | A | Parameterized bound quotient H-space package: for every universal def-stage1-pol… |
| `lem-stage1-bound-quotient-local-index` | lemma | stated | none | A | Parameterized same-map quotient local-index and ambient-chart package: for every… |
...
| `lem-stage1-exterior-cohomology` | lemma | stated | none | A | Exterior cohomology of a finite H-space over the real field: if M is a connected… |
| `lem-stage1-extra-fixed-class` | lemma | stated | none | A | Bound extra fixed class with one ledger selection: there exist one def-stage1-po… |
| `lem-stage1-fixed-unitary-projection-bridge` | lemma | stated | none | A | Fixed-unitary projection bridge: there are universal C_bridge<infinity and e_bri… |
| `lem-stage1-fresh-two-point-inclusion` | lemma | stated | none | A | There are universal C_pair<infinity and e_pair>0 such that every finite-dimensio… |
...
| `lem-stage1-hspace-coproduct-tail` | lemma | stated | none | A | H-space coproduct-tail package over the real field: if M is a connected CW compl… |
...
| `lem-stage1-left-inversion-associated-graded` | lemma | stated | none | A | Associated-graded action of a left inversion over the real field: if M is a conn… |
| `lem-stage1-left-inversion-trace` | lemma | stated | none | A | Left-inversion trace over the real field: if M is a connected CW complex with di… |
...
| `lem-stage1-original-complementary-pair` | lemma | stated | none | A | There are universal C_np<infinity and e_np>0 such that every finite-dimensional … |
...
| `lem-stage1-rectified-nontrivial-projection` | lemma | stated | none | A | There are universal C_proj<infinity and e_proj>0 such that every finite-dimensio… |
