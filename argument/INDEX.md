...
| `lem-maincb-binary-block-merge` | lemma | stated | none | A | If A is a finite-dimensional extended epsilon-C*-algebra, 0 <= epsilon <= epsilo… |
| `lem-maincb-corner-equivalence` | lemma | stated | none | A | There is a universal e_sim > 0 such that, for every finite family of one-dimensi… |
| `lem-maincb-cross-class-merging-datum` | lemma | stated | none | A | There are universal C_cross >= 1 and e_cross > 0 such that, if A is a finite-dim… |
| `lem-maincb-cross-union-zero-corners` | lemma | stated | none | A | There is a universal e_zero > 0 such that, if A is a finite-dimensional extended… |
| `lem-maincb-direct-corner-envelope` | lemma | stated | none | A | There are universal L >= 1 and e_env > 0 such that, if A is a finite-dimensional… |
| `lem-maincb-direct-sum-inclusion-merge` | lemma | stated | none | A | There are universal C_dir < infinity and e_dir > 0 such that, if B_1,B_2 are fin… |
| `lem-maincb-error-improvement` | lemma | stated | none | A | Complete error improvement: there are universal epsilon_max^cb>0, delta_max^cb>0… |
| `lem-maincb-full-corner-identification` | lemma | stated | none | A | There is a universal e_full > 0 such that, if R is a t-projection in an extended… |
| `lem-maincb-improvement-iteration` | lemma | stated | none | A | There are universal e_it > 0, K_disp < infinity, and K_floor < infinity such tha… |
| `lem-maincb-improvement-one-step` | lemma | stated | none | A | There are universal K_step >= 1 and e_step > 0 such that, if B is a finite-dimen… |
| `lem-maincb-initial-raw-inclusion` | lemma | stated | none | A | There are universal D_0 < infinity and e_0 > 0 such that, in every finite-dimens… |
| `lem-maincb-initial-reset-inclusion` | lemma | stated | none | A | For every finite-dimensional extended epsilon-C*-algebra A with 0 <= epsilon <= … |
| `lem-maincb-maximal-reset-selection` | lemma | stated | none | A | If A is a finite-dimensional extended epsilon-C*-algebra with 0 <= epsilon <= ep… |
| `lem-maincb-nested-corner-comparison` | lemma | stated | none | A | There are universal C_nest < infinity and e_nest > 0 such that, whenever R,P,Q a… |
| `lem-maincb-nested-corner-dimension-transport` | lemma | stated | none | A | There is a universal e_ncd > 0 such that, whenever R,P,Q are t-projections in a … |
| `lem-maincb-one-class-extension` | lemma | stated | none | A | If A is a finite-dimensional extended epsilon-C*-algebra, 0 <= epsilon <= epsilo… |
| `lem-maincb-outer-compression-transfer` | lemma | stated | none | A | There are universal C_out < infinity and e_out > 0 such that, whenever R,P are t… |
| `lem-maincb-reset-constant-ledger` | lemma | stated | none | A | With D_* = max{1,D_0,D_1,D_2,D_3} and r_reset := min{e_0,e_1,e_2,e_3,epsilon_max… |
| `lem-maincb-reset-invariant-preservation` | lemma | stated | none | A | For any explicit global-scalar, compressed-corner-scalar, Stage-1, Stage-2, or S… |
| `lem-maincb-stage1-call-envelope` | lemma | stated | none | A | After the Stage-1 producer gate, there are universal K_1 >= 1 and e_call_1 > 0, … |
| `lem-maincb-stage1-maximality` | lemma | stated | none | A | If A is a finite-dimensional extended epsilon-C*-algebra with 0 <= epsilon <= ep… |
| `lem-maincb-stage1-raw-refinement` | lemma | stated | none | A | There are universal D_1 < infinity and e_1 > 0 such that, if an explicit Stage-1… |
| `lem-maincb-stage1-strict-refinement` | lemma | stated | none | A | If A is a finite-dimensional extended epsilon-C*-algebra with 0 <= epsilon <= ep… |
| `lem-maincb-stage2-call-envelope` | lemma | stated | none | A | There are universal K_2 >= max{1,L,c_0^cb*L} and e_call_2 > 0, with K_2*e_call_2… |
| `lem-maincb-stage2-extcb-datum` | lemma | stated | none | A | There are universal C_s2 >= 1 and e_s2 > 0, with the e_ca threshold and universa… |
| `lem-maincb-stage2-raw-extension` | lemma | stated | none | A | There are universal D_2 < infinity and e_2 > 0, chosen with e_2 <= e_s2 and C_s2… |
| `lem-maincb-stage3-call-envelope` | lemma | stated | none | A | There are universal K_3 >= max{1,L,c_0^cb*L} and e_call_3 > 0, with K_3*e_call_3… |
| `lem-maincb-stage3-finite-recombination` | lemma | stated | none | A | If A is a finite-dimensional extended epsilon-C*-algebra, 0 <= epsilon <= epsilo… |
| `lem-maincb-stage3-raw-merge` | lemma | stated | none | A | There are universal D_3 < infinity and e_3 > 0, with e_3 <= a_merge/(C_cross+1),… |
| `lem-maincb-structural-assembly` | lemma | stated | none | A | There are universal C_struct = c_0^cb*K_call < infinity and e_struct = epsilon_M… |
| `lem-maincb-structural-domain-ledger` | lemma | stated | none | A | With the earlier witnesses, set K_call := max{1,L,c_0^cb,K_1,K_2,K_3} and epsilo… |
