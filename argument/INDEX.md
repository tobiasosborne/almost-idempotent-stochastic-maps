...
| `conj-extcb` | lemma | conjecture | none | A | EXT-CB: there are universal C_ext < infinity and e_ext > 0 such that if e=delta+… |
...
| `lem-prh` | lemma | proved-mod-audit | none | A | Positive-retract hardening (PRH): let k,n >= 1 and let A:l-infinity(k)->l-infini… |
...
| `lem-thmainext-conditional` | lemma | proved-mod-audit | none | A | Conditional th_main_ext assembly: assuming conj-hcb (H-CB) and conj-extcb (EXT-C… |
