...
| `lem-harmonic-affine-bridge` | lemma | proved | seeded | A | Harmonic-affine bridge: for an exact signed idempotent P with rows p_i = (P_ij)_… |
...
| `lem-row-far-dual-certificate` | lemma | proved | none | A | Row-far dual certificate: for an exact signed idempotent P and a geometrically d… |
