...
| `lem-prh-sharpness-family-arithmetic` | lemma | stated | none | A | Witness arithmetic for PRH sharpness: for every real lambda with 0 < lambda < 1/… |
...
| `lem-routef-f0-assembly` | lemma | proved | validated | A | Route F F0 assembly: there are universal eta_0,C > 0, independent of n, such tha… |
...
| `op-classical` | theorem | proved | validated | A | Classical projection stability: there are universal eta_0,C>0 (n-free) such that… |
