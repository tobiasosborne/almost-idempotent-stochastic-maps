...
| `lem-maincb-reset-invariant-preservation` | lemma | stated | seeded | A | After first fixing the universal e_it,K_disp,K_floor witnesses of lem-maincb-imp… |
...
| `lem-maincb-stage2-raw-extension` | lemma | stated | seeded | A | After first fixing the universal C_s2^0,e_s2^0 witnesses of lem-maincb-stage2-ex… |
...
| `lem-maincb-witness-arithmetic` | lemma | stated | seeded | A | After first fixing positive finite universal provider witnesses D_0,D_1,D_2,D_3,… |
