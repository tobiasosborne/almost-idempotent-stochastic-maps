...
| `lem-pivot-removing-move` | lemma | proved-mod-audit | none | A | Pivot-removing max-stationarity: let P be a rank-3 exact signed idempotent (squa… |
