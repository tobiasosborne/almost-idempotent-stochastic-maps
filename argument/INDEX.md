...
| `lem-maincb-stage3-raw-merge` | lemma | stated | seeded | A | There are universal D_3 < infinity and e_3 > 0, with e_3 <= a_merge/(C_cross+1),… |
| `lem-maincb-structural-assembly` | lemma | stated | seeded | A | There are universal C_struct = c_0^cb*K_call < infinity and e_struct = epsilon_M… |
| `lem-maincb-structural-domain-ledger` | lemma | stated | seeded | A | With the earlier witnesses, set K_call := max{1,L,c_0^cb,K_1,K_2,K_3} and epsilo… |
