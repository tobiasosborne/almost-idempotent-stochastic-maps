...
| `lem-hx-robust-scalar-starvation` | lemma | proved | none | B | For all reals K_R, L, K_C >= 0 there is a universal delta_R(K_R,L,K_C) in (0,2^(… |
...
| `lem-hx-transverse-moment-identity` | lemma | proved | none | B | For every finite exact signed idempotent P, all points q0 != q1 of the row polyt… |
