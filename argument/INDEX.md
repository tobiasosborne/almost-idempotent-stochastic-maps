...
| `lem-stage1-bound-quotient-left-inversion` | lemma | stated | seeded | A | Parameterized bound quotient H-space package: for every universal def-stage1-pol… |
| `lem-stage1-bound-quotient-local-index` | lemma | stated | seeded | A | Parameterized same-map quotient local-index and ambient-chart package: for every… |
...
| `lem-stage1-exterior-cohomology` | lemma | stated | seeded | A | Exterior cohomology of a finite H-space over the real field: if M is a connected… |
| `lem-stage1-extra-fixed-class` | lemma | stated | seeded | A | Bound extra fixed class with one ledger selection: there exist one def-stage1-po… |
| `lem-stage1-fixed-unitary-projection-bridge` | lemma | stated | seeded | A | Fixed-unitary projection bridge: there are universal C_bridge<infinity and e_bri… |
...
| `lem-stage1-rectified-nontrivial-projection` | lemma | stated | seeded | A | There are universal C_proj<infinity and e_proj>0 such that every finite-dimensio… |
