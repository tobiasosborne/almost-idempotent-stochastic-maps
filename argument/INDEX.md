...
| `lem-routef-degree-three-estimate` | lemma | stated | none | A | Route F degree-three estimate: with C_3 := 10+20*C_Delta+12*C_theta+2*C_Delta' a… |
| `lem-routef-degree-two-estimate` | lemma | stated | none | A | Route F degree-two estimate: with C_2 := C_Delta'+4*C_Delta and rho_2 := min{rho… |
| `lem-routef-delta-normalization-closeness` | lemma | stated | none | A | Delta UCP normalization: with C_Delta := 6*C_T+7*C_Delta' and rho_Delta := min{r… |
| `lem-routef-delta-phi-product` | lemma | stated | none | A | Normalized Delta product: for rho_DeltaPhi := min{rho_theta, rho_Delta, rho_2} a… |
| `lem-routef-delta-prime-closeness` | lemma | stated | none | A | Delta-prime CP closeness: with C_Delta' := C_T+4*C_theta and rho_Delta' := min{r… |
| `lem-routef-delta-upsilon-telescope` | lemma | stated | none | A | Delta-Upsilon telescope: for rho_DeltaUpsilon := min{rho_theta, rho_T, rho_id, r… |
...
| `lem-routef-k-finiteness` | lemma | stated | none | A | Route F common coefficient/domain: K in (1.6) is finite and universal, and rho_f… |
...
| `lem-routef-upsilon-delta-telescope` | lemma | stated | none | A | Upsilon-Delta telescope: for rho_UpsilonDelta := min{rho_T, rho_id, rho_Delta, r… |
| `lem-routef-upsilon-normalization-closeness` | lemma | stated | none | A | Upsilon UCP normalization: with C_Upsilon := 6*C_T+7*C_Upsilon' and rho_Upsilon … |
| `lem-routef-upsilon-prime-closeness` | lemma | stated | none | A | Upsilon-prime CP closeness: with C_N, C_R, C_L, C_Upsilon' from (1.3) and rho_Up… |
...
| `lem-thmainext-conditional` | lemma | proved-mod-audit | seeded | A | Extended th_main_ext assembly: there are universal C_E < infinity and epsilon_E … |
