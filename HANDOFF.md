...
2. Read **`docs/plans/2026-07-07-top-down-proof-sketch-v13.md`** — THE canonical strategic map
   (v13, session-12 round-3 DELTA redraw; v12 and earlier superseded in place, kept for line citations).
