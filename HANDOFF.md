...
2. Read **`docs/plans/2026-07-07-top-down-proof-sketch-v14.md`** — THE canonical strategic map
   (v14, session-12 round-4 DELTA redraw; v13 and earlier superseded in place, kept for line citations).
