...
| `ARG-LEM-KITAEV-ALMOST-IDEMP-AUDIT` | `argument/lemmas/lem-kitaev-almost-idemp-audit.md` | `918b0afb488f55a4` | Registry shard for `lem-kitaev-almost-idemp-audit` |
...
| `ARG-LEM-ROUTEF-FUNCTIONAL-CALCULUS-CLOSENESS` | `argument/lemmas/lem-routef-functional-calculus-closeness.md` | `92f5958aa79f1d20` | Registry shard for `lem-routef-functional-calculus-closeness` |
