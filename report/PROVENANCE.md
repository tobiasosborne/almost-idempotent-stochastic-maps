...
| lem:stage1-maurer-cartan-transport | ARG-LEM-STAGE1-MAURER-CARTAN-TRANSPORT AF-LEM-STAGE1-MAURER-CARTAN-TRANSPORT | registry contract and proof export node 1 | O | Contract quoted verbatim; status `stated`, `af: seeded` — the validation (13 nodes) was RETRACTED 2026-07-28 by the Stage-1 binder sweep (export node 1.3.3; a sound in-tree bypass exists in nodes 1.3.4-1.3.7; `docs/LEARNINGS.md` second entry); typeset as a conjecture with a retraction note. |
