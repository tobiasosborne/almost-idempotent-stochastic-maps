...
| lem:stage1-polar-path-transport | ARG-LEM-STAGE1-POLAR-PATH-TRANSPORT AF-LEM-STAGE1-POLAR-PATH-TRANSPORT | registry contract and proof export node 1 | O | Contract quoted verbatim; status `stated`, `af: seeded` — the validation (9 nodes) was RETRACTED 2026-07-28 by the Stage-1 binder sweep (export node 1.3.1; `docs/LEARNINGS.md` second entry); typeset as a conjecture with a retraction note. |
