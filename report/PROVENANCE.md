...
| `ARG-LEM-STAGE1-INVERSION-DERIVATIVE-CONTROL` | `argument/lemmas/lem-stage1-inversion-derivative-control.md` | `100566ad92684b27` | Registry shard for `lem-stage1-inversion-derivative-control` |
...
| lem:stage1-inversion-derivative-control | ARG-LEM-STAGE1-INVERSION-DERIVATIVE-CONTROL AF-LEM-STAGE1-INVERSION-DERIVATIVE-CONTROL | registry contract and proof export node 1 | O | Contract quoted verbatim; status `stated`, `af: seeded` — the 2026-07-27 validation was RETRACTED 2026-07-28 (adjudicated synchronization defect in export node 1.3; `docs/LEARNINGS.md`); typeset as a conjecture with a retraction note; the sign variable `s` is renamed to varsigma, a notation change only. |
