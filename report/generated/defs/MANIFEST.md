...
| 3 | `def-stochastic` | `def:stochastic` | consensus | locked | shard statement | — | `internal` | `adopted from ../almost-idempotent-positive-maps/definitions/def-stochastic.md` | `-` | 22 | 7 |
| 4 | `def-almost-idempotent` | `def:almost-idempotent` | consensus | locked | shard statement | — | `internal` | `adopted from ../almost-idempotent-positive-maps/definitions/def-almost-idempotent.md (stochastic specialization)` | `-` | 9 | 4 |
