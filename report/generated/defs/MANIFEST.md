...
- registry results in the strategy subgraph: **193**; registry results anchored in `report/sections/`: **73**
...
| 23 | `def-extended-epsilon-cstar-algebra` | `def:extended-epsilon-cstar-algebra` | cited | locked | translated (table v1) | 1 | `kitaev-2405.02434` | `approximate_algebras.tex:1477-1479` | `e7eb512a2ec2438d` | 53 | 18 |
...
| 29 | `def-operator-space` | `def:operator-space` | cited | locked | shard statement | — | `kitaev-2405.02434` | `approximate_algebras.tex:1453-1464 (Definition def:opspace)` | `e7eb512a2ec2438d` | 15 | 0 |
...
| 36 | `def-extended-delta-inclusion` | `def:extended-delta-inclusion` | consensus | locked | shard statement | — | `internal` | `harmonization of approximate_algebras.tex:443-456,1477-1484 prescribed by DESIGN-FUDW-DECOMP-v3.md §4.1` | `-` | 33 | 4 |
...
| 39 | `def-maincb-reset-state` | `def:maincb-reset-state` | original | locked | shard statement | — | `internal` | `DESIGN-FUDW-DECOMP-v4.1.md:419-423; DESIGN-MAIN-STRUCTURE-v5.md sect 1.2` | `-` | 17 | 0 |
| 40 | `def-maincb-partition-state` | `def:maincb-partition-state` | original | locked | shard statement | — | `internal` | `DESIGN-MAIN-STRUCTURE-v5.md sect 1.4` | `-` | 17 | 0 |
| 41 | `def-maincb-raw-call` | `def:maincb-raw-call` | original | locked | shard statement | — | `internal` | `DESIGN-FUDW-DECOMP-v4.1.md:424-428; DESIGN-MAIN-STRUCTURE-v5.md sect 1.3` | `-` | 16 | 0 |
| 42 | `def-maincb-witness-ledger` | `def:maincb-witness-ledger` | original | locked | shard statement | — | `internal` | `DESIGN-MAINCB-REPAIR-v2.md sect 2 (hostile-audited AUDIT-MAINCB-REPAIR.md, verdict VALID AS DATA)` | `-` | 19 | 0 |
