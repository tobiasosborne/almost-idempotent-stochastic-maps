...
step in \S\ref{sec:hcb4-canonical-inverse}. Nothing here bears on \texttt{op-classical}, which is now discharged at the af-validated rung via Route F (\S\ref{sec:status-outlook}); sharpness remains with \texttt{ex-hume}.
