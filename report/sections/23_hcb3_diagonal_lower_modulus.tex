...
that hypothesis, and to the not-yet-validated
\texttt{lem-hcb3-offdiagonal-inverse}. The parent \texttt{conj-hcb} remains
\texttt{proved-mod-audit} with \texttt{af: none}, and \texttt{op-classical} remains open.
